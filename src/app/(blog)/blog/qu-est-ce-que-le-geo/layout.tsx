...
// Layout commun à un article MDX — header avec métadonnées (catégorie,
// date, temps de lecture, auteur), titre, description, puis prose.
// La page.mdx fournit le contenu (children), le layout pose la mise
// en forme et les métadonnées SEO.

const ARTICLE_SLUG = "qu-est-ce-que-le-geo";
