      ...
      <DialogContent className="max-w-md">
        <div className="flex flex-col items-center text-center">
          ...
          <DialogDescription className="mt-2 max-w-sm">
            ...
            <strong className="text-[color:var(--color-ink)]">essai gratuit de 14 jours</strong>.
          </DialogDescription>
        </div>

        <ul className="mt-5 flex flex-col gap-2.5">
          {[
            "Ton tracking quotidien sur les 5 IA tourne déjà.",
            "Tu n'es pas facturé pendant l'essai.",
            "Tu choisiras ton plan quand tu veux, depuis ton compte.",
          ].map((line) => (
            <li key={line} className="flex items-start gap-2 text-sm text-[color:var(--color-ink-soft)]">
              <Check
                size={14}
                strokeWidth={3}
