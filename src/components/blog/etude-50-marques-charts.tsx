...
const CLASSEMENT: Marque[] = [
  {
    ...
    secteur: "Banque",
    score: 66.87,
    plateformes: { chatgpt: 67.19, claude: 78.12, perplexity: 62.5, gemini: 73.44, lechat: 53.12 },
  },
  {
    rang: 2,
    marque: "Fortuneo",
    secteur: "Banque",
    score: 49.06,
    plateformes: { chatgpt: 43.75, claude: 62.5, perplexity: 50.0, gemini: 42.19, lechat: 46.88 },
  },
  {
    rang: 3,
    marque: "Free",
    secteur: "Telecom & énergie",
    score: 40.31,
    plateformes: { chatgpt: 50.0, claude: 50.0, perplexity: 37.5, gemini: 32.81, lechat: 31.25 },
  },
  {
    rang: 4,
    marque: "BNP Paribas",
    secteur: "Banque",
    score: 38.44,
    plateformes: { chatgpt: 40.62, claude: 46.88, perplexity: 34.38, gemini: 35.94, lechat: 34.38 },
  },
  {
    rang: 5,
    marque: "Orange",
    secteur: "Telecom & énergie",
    score: 37.5,
    plateformes: { chatgpt: 43.75, claude: 37.5, perplexity: 43.75, gemini: 28.12, lechat: 34.38 },
  },
  {
    rang: 6,
    marque: "SFR",
    secteur: "Telecom & énergie",
    score: 37.5,
    plateformes: { chatgpt: 43.75, claude: 50.0, perplexity: 31.25, gemini: 25.0, lechat: 37.5 },
  },
  {
    rang: 7,
    marque: "Bouygues Telecom",
    secteur: "Telecom & énergie",
    score: 34.37,
    plateformes: { chatgpt: 43.75, claude: 31.25, perplexity: 40.62, gemini: 28.12, lechat: 28.12 },
  },
  {
    rang: 8,
    marque: "MAIF",
    secteur: "Assurance",
    score: 32.81,
    plateformes: { chatgpt: 40.62, claude: 43.75, perplexity: 32.81, gemini: 28.12, lechat: 18.75 },
  },
  {
    rang: 9,
    ...
    secteur: "Assurance",
    score: 31.87,
    plateformes: { chatgpt: 37.5, claude: 28.12, perplexity: 34.38, gemini: 18.75, lechat: 40.62 },
  },
  {
    rang: 10,
    ...
    secteur: "Banque",
    score: 28.44,
    plateformes: { chatgpt: 37.5, claude: 34.38, perplexity: 21.88, gemini: 23.44, lechat: 25.0 },
  },
  {
    rang: 11,
    marque: "Hello bank!",
    secteur: "Banque",
    score: 27.19,
    plateformes: { chatgpt: 35.94, claude: 28.12, perplexity: 18.75, gemini: 21.88, lechat: 31.25 },
  },
  {
    rang: 12,
    marque: "Crédit Mutuel",
    secteur: "Banque",
    score: 25.94,
    plateformes: { chatgpt: 15.62, claude: 37.5, perplexity: 21.88, gemini: 32.81, lechat: 21.88 },
  },
  {
    rang: 13,
    marque: "AXA",
    secteur: "Assurance",
    score: 25.62,
    plateformes: { chatgpt: 37.5, claude: 28.12, perplexity: 25.0, gemini: 6.25, lechat: 31.25 },
  },
  {
    rang: 14,
    marque: "Cdiscount",
    ...
    score: 25.0,
    plateformes: { chatgpt: 12.5, claude: 40.62, perplexity: 25.0, gemini: 15.62, lechat: 31.25 },
  },
  {
    rang: 15,
    marque: "RED by SFR",
    secteur: "Telecom & énergie",
    score: 24.37,
    plateformes: { chatgpt: 25.0, claude: 25.0, perplexity: 31.25, gemini: 15.62, lechat: 25.0 },
  },
  {
    rang: 16,
    marque: "Société Générale",
    secteur: "Banque",
    score: 24.06,
    plateformes: { chatgpt: 6.25, claude: 53.12, perplexity: 15.62, gemini: 17.19, lechat: 28.12 },
  },
  {
    rang: 17,
    marque: "Back Market",
    secteur: "Retail & e-commerce",
    score: 24.06,
    plateformes: { chatgpt: 18.75, claude: 37.5, perplexity: 14.06, gemini: 31.25, lechat: 18.75 },
  },
  {
    rang: 18,
    marque: "MMA",
    secteur: "Assurance",
    score: 21.88,
    plateformes: { chatgpt: 21.88, claude: 37.5, perplexity: 25.0, gemini: 6.25, lechat: 18.75 },
  },
  {
    rang: 19,
    marque: "Darty",
    secteur: "Retail & e-commerce",
    score: 21.87,
    plateformes: { chatgpt: 15.62, claude: 37.5, perplexity: 18.75, gemini: 21.88, lechat: 15.62 },
  },
  {
    rang: 20,
    marque: "Matmut",
    secteur: "Assurance",
    score: 21.25,
    plateformes: { chatgpt: 28.12, claude: 21.88, perplexity: 18.75, gemini: 25.0, lechat: 12.5 },
  },
  {
    rang: 21,
    marque: "Fnac",
    secteur: "Retail & e-commerce",
    score: 21.25,
    plateformes: { chatgpt: 18.75, claude: 43.75, perplexity: 6.25, gemini: 12.5, lechat: 25.0 },
  },
  {
    rang: 22,
    marque: "GMF",
    secteur: "Assurance",
    score: 20.63,
    plateformes: { chatgpt: 21.88, claude: 37.5, perplexity: 6.25, gemini: 18.75, lechat: 18.75 },
  },
  {
    rang: 23,
    marque: "Leroy Merlin",
    secteur: "Retail & e-commerce",
    score: 20.0,
    plateformes: { chatgpt: 25.0, claude: 18.75, perplexity: 18.75, gemini: 12.5, lechat: 25.0 },
  },
  {
    rang: 24,
    marque: "Groupama",
    secteur: "Assurance",
    score: 16.56,
    plateformes: { chatgpt: 25.0, claude: 12.5, perplexity: 25.0, gemini: 7.81, lechat: 12.5 },
  },
  {
    rang: 25,
    marque: "Leocare",
    secteur: "Assurance",
    score: 16.25,
    plateformes: { chatgpt: 12.5, claude: 28.12, perplexity: 0.0, gemini: 6.25, lechat: 34.38 },
  },
  {
    rang: 26,
    marque: "Sosh",
    secteur: "Telecom & énergie",
    score: 15.62,
    plateformes: { chatgpt: 18.75, claude: 18.75, perplexity: 15.62, gemini: 12.5, lechat: 12.5 },
  },
  {
    rang: 27,
    marque: "EDF",
    secteur: "Telecom & énergie",
    score: 15.0,
    plateformes: { chatgpt: 18.75, claude: 12.5, perplexity: 6.25, gemini: 28.12, lechat: 9.38 },
  },
  {
    rang: 28,
    marque: "E.Leclerc",
    secteur: "Retail & e-commerce",
    score: 14.06,
    plateformes: { chatgpt: 12.5, claude: 21.88, perplexity: 7.81, gemini: 18.75, lechat: 9.38 },
  },
  {
    rang: 29,
    marque: "PayFit",
    secteur: "Tech & services FR",
    score: 13.12,
    plateformes: { chatgpt: 15.62, claude: 12.5, perplexity: 12.5, gemini: 12.5, lechat: 12.5 },
  },
  {
    rang: 30,
    marque: "Decathlon",
    secteur: "Retail & e-commerce",
    score: 12.5,
    plateformes: { chatgpt: 12.5, claude: 12.5, perplexity: 6.25, gemini: 18.75, lechat: 12.5 },
  },
  {
    rang: 31,
    marque: "BlaBlaCar",
    secteur: "Tech & services FR",
    score: 12.5,
    plateformes: { chatgpt: 12.5, claude: 12.5, perplexity: 12.5, gemini: 12.5, lechat: 12.5 },
  },
  {
    rang: 32,
    marque: "Leboncoin",
  ...
  },
  {
    ...
    secteur: "Tech & services FR",
    score: 11.25,
    plateformes: { chatgpt: 12.5, claude: 6.25, perplexity: 12.5, gemini: 12.5, lechat: 12.5 },
  },
  {
    rang: 36,
    marque: "Deezer",
    secteur: "Tech & services FR",
    score: 11.25,
    plateformes: { chatgpt: 12.5, claude: 12.5, perplexity: 6.25, gemini: 12.5, lechat: 12.5 },
  },
  {
    rang: 37,
    marque: "Yuka",
    secteur: "Tech & services FR",
    score: 11.25,
    plateformes: { chatgpt: 6.25, claude: 12.5, perplexity: 12.5, gemini: 12.5, lechat: 12.5 },
  },
  {
    rang: 38,
    marque: "MACIF",
    secteur: "Assurance",
    score: 10.31,
    plateformes: { chatgpt: 9.38, claude: 12.5, perplexity: 1.56, gemini: 15.62, lechat: 12.5 },
  },
  {
    rang: 39,
    marque: "Qonto",
    secteur: "Banque",
    score: 10.0,
    plateformes: { chatgpt: 12.5, claude: 6.25, perplexity: 12.5, gemini: 6.25, lechat: 12.5 },
  },
  {
    rang: 40,
    marque: "La Redoute",
    secteur: "Retail & e-commerce",
    score: 7.5,
    plateformes: { chatgpt: 6.25, claude: 15.62, perplexity: 3.12, gemini: 12.5, lechat: 0.0 },
  },
  {
    rang: 41,
    marque: "La Banque Postale",
    secteur: "Banque",
    score: 6.25,
    plateformes: { chatgpt: 0.0, claude: 18.75, perplexity: 0.0, gemini: 3.12, lechat: 9.38 },
  },
  {
    rang: 42,
    marque: "ManoMano",
    secteur: "Retail & e-commerce",
    score: 6.25,
    plateformes: { chatgpt: 9.38, claude: 9.38, perplexity: 6.25, gemini: 0.0, lechat: 6.25 },
  },
  {
    rang: 43,
    marque: "Mint Énergie",
    secteur: "Telecom & énergie",
    score: 5.62,
    plateformes: { chatgpt: 15.62, claude: 0.0, perplexity: 6.25, gemini: 3.12, lechat: 3.12 },
  },
  {
    rang: 44,
    marque: "Engie",
    secteur: "Telecom & énergie",
    score: 5.31,
    plateformes: { chatgpt: 9.38, claude: 6.25, perplexity: 3.12, gemini: 6.25, lechat: 1.56 },
  },
  {
    rang: 45,
    marque: "Alan",
    secteur: "Assurance",
    score: 5.0,
    plateformes: { chatgpt: 3.12, claude: 3.12, perplexity: 3.12, gemini: 12.5, lechat: 3.12 },
  },
  {
    rang: 46,
    marque: "Carrefour",
    secteur: "Retail & e-commerce",
    score: 4.06,
    plateformes: { chatgpt: 0.0, claude: 12.5, perplexity: 1.56, gemini: 3.12, lechat: 3.12 },
  },
  {
    rang: 47,
    ...
    secteur: "Telecom & énergie",
    score: 3.75,
    plateformes: { chatgpt: 6.25, claude: 6.25, perplexity: 6.25, gemini: 0.0, lechat: 0.0 },
  },
  {
    rang: 48,
    marque: "CIC",
    secteur: "Banque",
    score: 3.12,
    plateformes: { chatgpt: 0.0, claude: 0.0, perplexity: 0.0, gemini: 3.12, lechat: 12.5 },
  },
  {
    rang: 49,
    marque: "Sumeria",
    secteur: "Tech & services FR",
    score: 0.0,
    plateformes: { chatgpt: 0.0, claude: 0.0, perplexity: 0.0, gemini: 0.0, lechat: 0.0 },
  },
  {
    rang: 50,
    marque: "Mistral AI",
    ...
    >
      <div className="mb-4 flex flex-wrap gap-4">
        {labels.map((label, i) => (
          <span
            key={label}
            className="flex items-center gap-1.5 text-xs text-[color:var(--color-ink-soft)]"
          >
            <span
              aria-hidden
...
export function EtudeSources() {
  ...
  return (
    ...
    >
      <BreakdownBars mode="share" segments={types.map((t) => ({ ...t, suffix: " citations" }))} />
    </ChartFrame>
  );
}
